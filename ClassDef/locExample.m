...
tNoPrior = SymGaussMLE('initialGuess',[0 0 log([0.8 100 1.5])],...
                       'prior',psfLogNoPrior);
                   
tNormPrior = SymGaussMLE('initialGuess',[0 0 log([0.8 100 1.5])],...
                       'prior',psfLogPrior_symGauss);
...
for frame=1:size(MV,3)
    ...
    if(~isempty(ind));
        ...
        [frameCoord,frameCov,framePar]=...
            refineSingleFrame(frameCoord0,currentFluoFrame,fluoOffset,ROIwidth,Nquad,logLobj,...
            tNormPrior);
