/*
 HMM_multiViterbi_log_startend.c
 =========================================================================
...
/*
 ...
 function s=HMM_multiViterbi_log_startend(lnQ,lnH,iStart,iEnd) 
...
void mexFunction(int nlhs, mxArray *plhs[],
    ...
    double *lnQ,*lnH,*iStart,*iEnd; /* inputparameters */
    ...
    if( (Mends==1) && (Nends >=1) ){ /* then do nothing */
        ...
        mexErrMsgTxt("iEnd must be a 1-by-N or N-by-1 matrix.");
    }
    ...
    /* initialize all s-entries to -1, which will give 0 after transforming 
     * back to Matlab's index convention */
    for(t=0;t<T;t++){s[t]=-1;}
